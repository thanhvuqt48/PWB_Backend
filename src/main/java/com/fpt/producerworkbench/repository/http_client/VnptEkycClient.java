...
@FeignClient(
        name = "vnpt-ekyc",
        url = "${vnpt.ekyc.base-url}",
        configuration = VnptEkycClientConfig.class
)
public interface VnptEkycClient {
    ...
    @PostMapping(value = "/ai/v1/classify/id", consumes = MediaType.APPLICATION_JSON_VALUE,
            produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @PostMapping(value = "/ai/v1/face/compare", consumes = MediaType.APPLICATION_JSON_VALUE,
            produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @PostMapping(value = "/ai/v1/card/liveness", consumes = MediaType.APPLICATION_JSON_VALUE,
            produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @PostMapping(value = "/ai/v1/face/liveness", consumes = MediaType.APPLICATION_JSON_VALUE,
            produces = MediaType.APPLICATION_JSON_VALUE)
