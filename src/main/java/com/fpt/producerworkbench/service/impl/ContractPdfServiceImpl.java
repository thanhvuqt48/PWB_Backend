...
public class ContractPdfServiceImpl implements ContractPdfService {
    ...
    static final String[][] TABLE_FIELDS = new String[][]{
            {"Text Box 22","Text Box 23","Text Box 24","Text Box 25","Text Box 26"},       // line1
            {"Text Box 27","Text Box 28","Text Box 29","Text Box 30","Text Box 31"},       // line2
            {"Text Box 32","Text Box 33","Text Box 34","Text Box 35","Text Box 36"},       // line3
            {"Text Box 32,1","Text Box 33,1","Text Box 34,1","Text Box 35,1","Text Box 36,1"}, // line4
            {"Text Box 32,2","Text Box 33,2","Text Box 34,2","Text Box 35,2","Text Box 36,2"}, // line5
            {"Text Box 32,3","Text Box 33,3","Text Box 34,3","Text Box 35,3","Text Box 36,3"}, // line6
            {"Text Box 32,4","Text Box 33,4","Text Box 34,4","Text Box 35,4","Text Box 36,4"}, // line7
            {"Text Box 32,5","Text Box 33,5","Text Box 34,5","Text Box 35,5","Text Box 36,5"}, // line8
            {"Text Box 32,6","Text Box 33,6","Text Box 34,6","Text Box 35,6","Text Box 36,6"}, // line9
            {"Text Box 32,7","Text Box 33,7","Text Box 34,7","Text Box 35,7","Text Box 36,7"}  // line10
    };
    ...
    private void drawMilestones(PdfDocument pdf,
        ...
        if (frame != null && !frame.getWidgets().isEmpty() && frame.getWidgets().get(0).getPage() != null) {
            ...
            if (numPages < desiredPage) {
                com.itextpdf.kernel.geom.PageSize baseSize =
                        (numPages >= 1) ? new PageSize(pdf.getPage(1).getPageSize()) : PageSize.A4;
    ...
    private record Line(String item, String unit, Integer qty, String price, String amount) {}

    private List<Line> collectLines(ContractPdfFillRequest r) {
        List<Line> list = new ArrayList<>(10);
        list.add(new Line(r.getLine1Item(),  r.getLine1Unit(),  r.getLine1Qty(),  r.getLine1Price(),  r.getLine1Amount()));
        list.add(new Line(r.getLine2Item(),  r.getLine2Unit(),  r.getLine2Qty(),  r.getLine2Price(),  r.getLine2Amount()));
        list.add(new Line(r.getLine3Item(),  r.getLine3Unit(),  r.getLine3Qty(),  r.getLine3Price(),  r.getLine3Amount()));
        list.add(new Line(r.getLine4Item(),  r.getLine4Unit(),  r.getLine4Qty(),  r.getLine4Price(),  r.getLine4Amount()));
        list.add(new Line(r.getLine5Item(),  r.getLine5Unit(),  r.getLine5Qty(),  r.getLine5Price(),  r.getLine5Amount()));
        list.add(new Line(r.getLine6Item(),  r.getLine6Unit(),  r.getLine6Qty(),  r.getLine6Price(),  r.getLine6Amount()));
        list.add(new Line(r.getLine7Item(),  r.getLine7Unit(),  r.getLine7Qty(),  r.getLine7Price(),  r.getLine7Amount()));
        list.add(new Line(r.getLine8Item(),  r.getLine8Unit(),  r.getLine8Qty(),  r.getLine8Price(),  r.getLine8Amount()));
        list.add(new Line(r.getLine9Item(),  r.getLine9Unit(),  r.getLine9Qty(),  r.getLine9Price(),  r.getLine9Amount()));
        list.add(new Line(r.getLine10Item(), r.getLine10Unit(), r.getLine10Qty(), r.getLine10Price(), r.getLine10Amount()));
        return list;
    }
    ...
    private MoneyTotals computeTotals(ContractPdfFillRequest req) {
        ...
        for (Line ln : collectLines(req)) {
            if (ln == null) continue;
            sum = sum.add(parseMoney(ln.amount));
        }
        BigDecimal vat = sum.multiply(DEFAULT_VAT_RATE).setScale(0, RoundingMode.HALF_UP);
        BigDecimal total = sum.add(vat);
        return new MoneyTotals(sum, vat, total);
